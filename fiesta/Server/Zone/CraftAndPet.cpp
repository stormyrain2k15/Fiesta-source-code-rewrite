...
int32 PetRelatedSkill::OwnerStatBonus(uint16) { return 5; } // EV_VERIFY
...
int32 ShineObjectMover::SpeedBonusPct(uint16 t) { return 30 + (int32)t * 10; } // EV_VERIFY
...
int32 GambleDiceTaiSaiObject::PayoutFor(uint16, uint16) { return 1; } // EV_VERIFY
