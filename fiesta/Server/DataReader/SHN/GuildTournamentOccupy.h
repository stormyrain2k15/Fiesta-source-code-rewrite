...
#ifndef SHINE_DATAREADER_SHN_GUILDTOURNAMENTOCCUPY_H
#define SHINE_DATAREADER_SHN_GUILDTOURNAMENTOCCUPY_H
...
#endif // SHINE_DATAREADER_SHN_GUILDTOURNAMENTOCCUPY_H
