...
#ifndef SHINE_DATAREADER_SHN_ITEMSERVEREQUIPTYPEINFO_H
#define SHINE_DATAREADER_SHN_ITEMSERVEREQUIPTYPEINFO_H
...
#endif // SHINE_DATAREADER_SHN_ITEMSERVEREQUIPTYPEINFO_H
