...
#ifndef SHINE_DATAREADER_SHN_CHARACTERTITLESTATESERVER_H
#define SHINE_DATAREADER_SHN_CHARACTERTITLESTATESERVER_H
...
#endif // SHINE_DATAREADER_SHN_CHARACTERTITLESTATESERVER_H
